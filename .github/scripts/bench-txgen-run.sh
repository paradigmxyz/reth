...
#               BENCH_OTLP_TRACES_HEADERS, BENCH_OTLP_LOGS_ENDPOINT,
#               BENCH_OTLP_LOGS_HEADERS, BENCH_OTLP_DISABLED,
...
if [ -n "${BENCH_OTLP_TRACES_HEADERS:-}" ]; then
  SUDO_ENV+=("OTEL_EXPORTER_OTLP_TRACES_HEADERS=${BENCH_OTLP_TRACES_HEADERS}")
fi
if [ -n "${BENCH_OTLP_LOGS_HEADERS:-}" ]; then
  SUDO_ENV+=("OTEL_EXPORTER_OTLP_LOGS_HEADERS=${BENCH_OTLP_LOGS_HEADERS}")
fi
