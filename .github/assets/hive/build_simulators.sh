...
docker save hive/simulators/ethereum/eest/consume-engine:latest -o ../hive_assets/eels_engine.tar & saving_pids+=( $! )
docker save hive/simulators/ethereum/eest/consume-rlp:latest -o ../hive_assets/eels_rlp.tar & saving_pids+=( $! )
