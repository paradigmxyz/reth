...
./hive -client reth --sim "ethereum/eels" \
  --sim.buildarg fixtures=https://github.com/ethereum/execution-spec-tests/releases/download/bal@v5.0.0/fixtures_bal.tar.gz \
  --sim.buildarg branch=eips/amsterdam/eip-7843 \
