...
use reth_primitives::{hex_literal::hex, Bytes, Header, PeerId, H256, U256};
    ...
    C: BlockProvider + HeaderProvider + 'static,
{
    ...
    handle.peers_handle().add_peer(PeerId(hex!("c6e7a6a1934fa4bcad9bd448afd490661c6f2186fd07fe68ae76805bedbe0631594ed320f9a420cdcfe8510079135c1496f41a6b9c7c6f452dc7ebd640356f47")), SocketAddr::new(IpAddr::V4(15, 204, 197, 5), 30303));
