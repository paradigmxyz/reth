...
///     gauge: Gauge,
///     #[metric(rename = "second_gauge", describe = "A counter with metric attribute description.")]
///     gauge2: Gauge,
///     /// Some doc comment
...
///         metrics::describe_gauge!("metrics.custom.second_gauge", "A counter with metric attribute description.");
