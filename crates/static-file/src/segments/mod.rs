...
use reth_provider::{providers::StaticFileProvider, DatabaseProviderRO, ProviderError, TransactionsProviderExt};
...
pub(crate) fn prepare_jar<DB: Database, const COLUMNS: usize>(
    ...
    nippy_jar = match segment_config.compression {
        ...
        Compression::ZstdWithDictionary => {
            ...
            nippy_jar.prepare_compression(dataset.to_vec()).map_err(|e| ProviderError::NippyJar(e.to_string()))?;
            nippy_jar
        }
