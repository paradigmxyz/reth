...
mod tests {
    ...
    fn base_mainnet_genesis() {
        ...
        let base_fee = BASE_MAINNET.next_block_base_fee(&genesis, genesis.timestamp);
    ...
    fn base_sepolia_genesis() {
        ...
        let base_fee = BASE_SEPOLIA.next_block_base_fee(&genesis, genesis.timestamp);
    ...
    fn op_sepolia_genesis() {
        ...
        let base_fee = OP_SEPOLIA.next_block_base_fee(&genesis, genesis.timestamp);
