    ...
    N: OpPayloadPrimitives,
{
    ...
    pub fn apply_pre_beacon_root_contract_call(
        ...
        SystemCaller::new(self.chain_spec.clone())
    ...
    pub fn execute_sequencer_transactions<'a, DB>(
        &self,
        evm: &mut impl Evm<DB = &'a mut State<DB>, Tx = EvmConfig::TxEnv>,
    ...
    pub fn execute_best_transactions(
        ...
        evm: &mut impl Evm<DB: DatabaseCommit, Tx = EvmConfig::TxEnv>,
