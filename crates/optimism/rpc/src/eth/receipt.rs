...
mod test {
    ...
    const L1_META_TX_1_EXEC_TX_OP_MAINNET_BLOCK_124665056: OptimismTransactionReceiptFields =
        OptimismTransactionReceiptFields {
            l1_block_info: L1BlockInfo {
                ...
                l1_fee_scalar: None,
                l1_base_fee_scalar: Some(4), /* todo: what was it for tx 0x10..41 in block
                                              * mainnet
                                              * 124665056? */
    ...
    fn parse_l1_info_fjord() {
        ...
        let l1_base_fee_scalar = U256::from(4);
        let l1_blob_base_fee = Some(U256::from(1));
        let l1_blob_base_fee_scalar = Some(U256::ZERO);
    ...
    fn decode_tx() {
        let mut data: &[u8] = {
            &hex!("")
        };
        let tx = TransactionSigned::decode_enveloped(&mut data);
