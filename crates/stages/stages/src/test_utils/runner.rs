...
use reth_provider::{test_utils::MockNodeTypes, DatabaseProvider, ProviderError};
use reth_stages_api::{
...
pub(crate) trait StageTestRunner {
    type S: Stage<DatabaseProvider<<TempDatabase<DatabaseEnv> as Database>::TXMut, MockNodeTypes>>
        + 'static;
