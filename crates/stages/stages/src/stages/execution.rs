    ...
    E: BlockExecutorProvider,
{
    ...
    where
        Provider: StaticFileProviderFactory + DBProvider + BlockReader + HeaderProvider<Header = reth_primitives::Header>,
    {
...
where
    ...
    Provider: DBProvider
        + BlockReader<Block = <E::Primitives as NodePrimitives>::Block, Header = <E::Primitives as NodePrimitives>::BlockHeader>
