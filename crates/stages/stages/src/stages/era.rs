...
impl<BH: Debug, BB: Debug> Debug for EraStage<BH, BB> {
...
impl<Provider, B, BB, BH> Stage<Provider> for EraStage<BH, BB>
where
...
mod tests {
    ...
    mod test_runner {
        ...
        impl Iterator for TestIter {
            type Item = (alloy_consensus::Header, alloy_consensus::BlockBody<TransactionSigned>);
        ...
        impl StageTestRunner for EraTestRunner {
            type S =
                EraStage<alloy_consensus::Header, alloy_consensus::BlockBody<TransactionSigned>>;
