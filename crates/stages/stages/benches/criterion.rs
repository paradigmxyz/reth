...
fn merkle(c: &mut Criterion, runtime: &Runtime) {
    ...
    let stage = MerkleStage::<EthPrimitives>::Both { rebuild_threshold: u64::MAX, incremental_threshold: u64::MAX };
    measure_stage(
        runtime,
        &mut group,
        &db,
    ...
    let stage = MerkleStage::<EthPrimitives>::Both { rebuild_threshold: 0, incremental_threshold: 0 };
    measure_stage(
        runtime,
        &mut group,
        &db,
