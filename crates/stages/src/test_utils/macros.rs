         ...
         paste::item! {
            ...
            async fn [< execute_ $name>] () {
                ...
                let input = crate::stage::ExecInput {
                    previous_stage: Some((crate::test_utils::PREV_STAGE_ID, reth_primitives::StageCheckpoint::new_with_block_number(previous_stage))),
                    checkpoint: Some(reth_primitives::StageCheckpoint::new_with_block_number(stage_progress)),
                };
            ...
            async fn [< unwind_ $name>] () {
                ...
                let unwind_input = crate::stage::UnwindInput {
                    ...
                    checkpoint: reth_primitives::StageCheckpoint::new_with_block_number(previous_stage),
                    bad_block: None,
                };
        ...
        crate::test_utils::stage_test_suite!($runner, $name);
         ...
         paste::item! {
            ...
            async fn [< execute_already_reached_target_ $name>] () {
                ...
                let mut runner = $runner::default();
                let input = crate::stage::ExecInput {
                    previous_stage: Some((crate::test_utils::PREV_STAGE_ID, reth_primitives::StageCheckpoint::new_with_block_number(stage_progress))),
                    checkpoint: Some(reth_primitives::StageCheckpoint::new_with_block_number(stage_progress)),
                };
                let seed = runner.seed_execution(input).expect("failed to seed");
