...
// receipts     /// of each transaction in the transactions list portion of the block; formally He.
...
//     /// Heavy function that will calculate hash of data and will *not* save the change to
// metadata.     /// Use [`Header::seal`], [`SealedHeader`] and unlock if you need hash to be
// persistent.     pub fn hash_slow(&self) -> B256 {
...
//         // Create a header indicating the encoded content is a list with the payload length
// computed         // from the header's payload calculation function.
//         let list_header =
