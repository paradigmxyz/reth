...
pub trait TransactionPool: Send + Sync + Clone {
    ...
    /// Vec<PooledTransactionResponse> This adheres to the expected behavior of [`GetPooledTransactions`](https://github.com/ethereum/devp2p/blob/master/caps/eth.md#getpooledtransactions-0x09):
