...
/// Returns a new [Pool] from validator, used for testing purposes
...
/// Returns a new [Pool] from a blob store, used for testing purposes
pub fn testing_pool_with_blob_store(blob_store: InMemoryBlobStore) -> TestPool {
    Pool::new(
