...
use reth_provider::{
    BlockNumReader, BlockWriter, ChainSpecProvider, DatabaseProviderFactory,
    LatestStateProviderRef, OriginalValuesKnown, ProviderFactory, StateWriter, StorageLocation,
};
...
impl<C: ChainSpecParser> Command<C> {
    ...
    where
        N: CliNodeTypes<ChainSpec: Hardforks>,
        C: ChainSpecParser<ChainSpec = N::ChainSpec>,
    {
        ...
        let executor_provider = components.evm_config();
        ...
        let block_range_client = FullBlockClient::new(fetch_client, Arc::new(consensus));
