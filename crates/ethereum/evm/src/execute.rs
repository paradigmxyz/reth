...
use reth_revm::{db::State, StateProviderDatabase};
        ...
        >,
{
    ...
    type Strategy<DB: StateProvider> = EthExecutionStrategy<DB, EvmConfig>;
...
mod tests {
    ...
    fn block_gas_limit_error() {
        ...
        let executor = executor_provider(chain_spec).executor(&db);
