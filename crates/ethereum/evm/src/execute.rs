...
impl<EvmConfig> EthExecutionStrategyFactory<EvmConfig> {
    ...
    pub fn new(chain_spec: Arc<ChainSpec>, evm_config: EvmConfig) -> Self {
        Self { system_caller: SystemCaller::new(chain_spec.clone()), chain_spec, evm_config }
    }
}
...
impl<'a, Evm, EvmConfig> EthExecutionStrategy<'a, Evm, EvmConfig> {
    ...
    pub fn new(
        ...
        Self { evm: EvmWithHook::new(evm), factory, block, receipts: Vec::new() }
    }
}
    ...
    EvmConfig: ConfigureEvmEnv<Transaction = TransactionSigned>,
{
    ...
    fn apply_post_execution_changes(
        ...
        if let Some(hook) = &mut self.evm.hook {
            hook.on_state(&balance_state);
        }
