...
/// Beneficiary that received the drained DAO balances.
pub(crate) static DAO_HARDFORK_BENEFICIARY: Address =
    address!("0xbf4ed7b27f1d666546e30d74d50d173d20bca754");

/// Accounts whose balances were drained at the DAO fork.
pub(crate) static DAO_HARDFORK_ACCOUNTS: [Address; 116] = [
