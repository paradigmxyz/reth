...
use reth_rpc::{eth::core::ComponentsWrapper, EthApi, ValidationApi};
...
where
    ...
    EthApi<ComponentsWrapper<N::Provider, N::Pool, N::Network, N::Evm>>:
        FullEthApiServer<Provider = N::Provider, Pool = N::Pool>,
{
    type EthApi = EthApi<ComponentsWrapper<N::Provider, N::Pool, N::Network, N::Evm>>;
    ...
    EthB: EthApiBuilder<N>,
{
    ...
    {
        let Self { inner } = self;
        EthereumAddOns { inner: inner.with_engine_api(engine_api_builder) }
    }
