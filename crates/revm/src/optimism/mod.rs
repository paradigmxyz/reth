...
pub const CREATE_2_DEPLOYER_ADDR: Address = address!("13b0D85CcB8bf860b6b79AF3029fCA081AE9beF2");
/// The codehash of the create2 deployer contract.
pub const CREATE_2_DEPLOYER_CODEHASH: B256 =
...
where
    DB: revm::Database,
{
    if chain_spec.fork_timestamps.canyon.unwrap_or_default() == timestamp &&
