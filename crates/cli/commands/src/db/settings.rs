...
pub enum SetCommand {
    ...
    /// Store storages history in RocksDB instead of the database
    StoragesHistoryRocksdb {
        #[clap(action(ArgAction::Set))]
        value: bool,
    },
    /// Store transaction hash numbers in RocksDB instead of the database
    TransactionHashNumbersRocksdb {
        #[clap(action(ArgAction::Set))]
        value: bool,
    },
    /// Store account history in RocksDB instead of the database
    AccountHistoryRocksdb {
        #[clap(action(ArgAction::Set))]
        value: bool,
    },
}
...
impl Command {
    ...
    fn set<N: ProviderNodeTypes>(&self, cmd: SetCommand, tool: &DbTool<N>) -> eyre::Result<()> {
        ...
        match cmd {
            ...
            SetCommand::StoragesHistoryRocksdb { value } => {
            ...
            SetCommand::TransactionHashNumbersRocksdb { value } => {
            ...
            SetCommand::AccountHistoryRocksdb { value } => {
