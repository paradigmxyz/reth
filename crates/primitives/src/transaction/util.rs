...
mod impl_secp256k1 {
    ...
    pub fn sign_message(secret: B256, message: B256) -> Result<Signature, Error> {
        ...
        let signature = Signature {
            ...
            parity: Parity::Parity(rec_id.to_i32() != 0),
        };
        Ok(signature)
    }
...
mod impl_k256 {
    ...
    pub fn sign_message(secret: B256, message: B256) -> Result<Signature, Error> {
        ...
        let signature = Signature {
            ...
            parity: Parity::Parity(rec_id.is_y_odd()),
        };
        Ok(signature)
    }
...
mod tests {
    ...
    fn sanity_secp256k1_k256_compat() {
        ...
        sig[64] = secp256k1_signature.parity.y_parity() as u8;
        ...
        sig[64] = k256_signature.parity.y_parity() as u8;
        let k256_recovered =
