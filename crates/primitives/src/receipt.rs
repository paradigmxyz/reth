...
use reth_codecs::{add_arbitrary_tests, reth_db_codec, Compact};
...
#[cfg_attr(feature = "zstd-codec", reth_db_codec(no_arbitrary, zstd))]
#[cfg_attr(not(feature = "zstd-codec"), reth_db_codec(no_arbitrary))]
#[add_arbitrary_tests]
