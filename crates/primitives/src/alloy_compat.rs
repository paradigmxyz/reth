...
//                     // alloy deserializes empty blocks into `BlockTransactions::Hashes`, if the
// tx                     // root is the empty root then we can just return an empty vec.
...
//                 nonce: nonce.ok_or_else(|| ConversionError::Custom("missing
// nonce".to_string()))?,                 base_fee_per_gas,
//                 withdrawals_root,
//                 blob_gas_used,
//                 excess_blob_gas,
//                 parent_beacon_block_root,
