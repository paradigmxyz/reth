...
pub fn calculate_receipt_root(
    ...
    // hardfork.
    if chain_spec.is_fork_active_at_timestamp(reth_ethereum_forks::Hardfork::Regolith, timestamp) &&
        !chain_spec.is_fork_active_at_timestamp(reth_ethereum_forks::Hardfork::Canyon, timestamp)
    {
