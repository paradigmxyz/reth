...
// impl<Node, DB, Types: NodeTypes, Components> LaunchNode<Node, DB, Types, Components> for
// DefaultLauncher {     fn launch(
//         builder: NodeBuilder<DB, ComponentsState<Types, Components,
// FullNodeComponentsAdapter<FullNodeTypesAdapter<Types, DB, BlockchainProvider<DB,
// ShareableBlockchainTree<DB, EvmProcessorFactory<<Types as NodeTypes>::Evm>>>>, <Components as
// NodeComponentsBuilder<FullNodeTypesAdapter<Types, DB, BlockchainProvider<DB,
// ShareableBlockchainTree<DB, EvmProcessorFactory<<Types as NodeTypes>::Evm>>>>>>::Pool>>>,
//         executor: TaskExecutor,
//         data_dir: ChainPath<DataDirPath>,
...
//             Components,
//             FullNodeComponentsAdapter<
//                 FullNodeTypesAdapter<Types, DB, RethFullProviderType<DB, <Types as
// NodeTypes>::Evm>>,                 <Components as
...
// impl<Node, DB, Types, Components> LaunchNode<Node, DB, Types, Components> for DefaultLauncher {
//     async fn launch(
//         builder: NodeBuilder<DB, State>,
//         executor: TaskExecutor,
//         data_dir: ChainPath<DataDirPath>,
