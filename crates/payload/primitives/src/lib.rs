...
//!
//! This crate provides a framework for execution payloads - the fundamental building
//! blocks containing transaction data in blockchain systems. While these types support
//! the Engine API, they are general abstractions useful for block building, validation,
...
///
/// Establishes a type system for payload operations, enabling generic implementations
