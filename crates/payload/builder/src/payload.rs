...
use reth_rpc_types_compat::engine::payload::{
    ...
    convert_standalone_withdraw_to_withdrawal, try_block_to_payload_v1, from_primitive_sidecar,
};
...
impl From<BuiltPayload> for ExecutionPayloadEnvelopeV3 {
    fn from(value: BuiltPayload) -> Self {
        ...
        ExecutionPayloadEnvelopeV3 {
            ...
            blobs_bundle: sidecars.into_iter().map(|s| from_primitive_sidecar(s)).collect::<Vec<_>>().into(),
        }
    }
}
