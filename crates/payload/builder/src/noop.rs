...
use crate::{service::PayloadServiceCommand, BuiltPayload, PayloadBuilderHandle};
...
pub struct NoopPayloadBuilderService {
    ...
    command_rx: UnboundedReceiverStream<PayloadServiceCommand<BuiltPayload>>,
}

impl NoopPayloadBuilderService {
    /// Creates a new [NoopPayloadBuilderService].
    pub fn new() -> (Self, PayloadBuilderHandle<BuiltPayload>) {
