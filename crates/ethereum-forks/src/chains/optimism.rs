...
pub static OP_MAINNET_HARDFORKS: Lazy<OptimismForks> = Lazy::new(|| {
    OptimismForks(vec![
        ...
        (Box::new(Hardfork::Berlin), ForkCondition::Block(3950000)),
        (Box::new(Hardfork::London), ForkCondition::Block(105235063)),
        (Box::new(Hardfork::ArrowGlacier), ForkCondition::Block(105235063)),
        (Box::new(Hardfork::GrayGlacier), ForkCondition::Block(105235063)),
        (
            Box::new(Hardfork::Paris),
            ForkCondition::TTD { fork_block: Some(105235063), total_difficulty: U256::ZERO },
        ),
        (Box::new(OptimismHardfork::Bedrock), ForkCondition::Block(105235063)),
        (Box::new(OptimismHardfork::Regolith), ForkCondition::Timestamp(0)),
        (Box::new(Hardfork::Shanghai), ForkCondition::Timestamp(1704992401)),
        (Box::new(OptimismHardfork::Canyon), ForkCondition::Timestamp(1704992401)),
        (Box::new(Hardfork::Cancun), ForkCondition::Timestamp(1710374401)),
        (Box::new(OptimismHardfork::Ecotone), ForkCondition::Timestamp(1710374401)),
        (Box::new(OptimismHardfork::Fjord), ForkCondition::Timestamp(1720627201)),
    ])
});
...
pub static OP_SEPOLIA_HARDFORKS: Lazy<OptimismForks> = Lazy::new(|| {
    OptimismForks(vec![
        ...
        (Box::new(Hardfork::ArrowGlacier), ForkCondition::Block(0)),
        (Box::new(Hardfork::GrayGlacier), ForkCondition::Block(0)),
        (
            Box::new(Hardfork::Paris),
            ForkCondition::TTD { fork_block: Some(0), total_difficulty: U256::ZERO },
        ),
        (Box::new(OptimismHardfork::Bedrock), ForkCondition::Block(0)),
        (Box::new(OptimismHardfork::Regolith), ForkCondition::Timestamp(0)),
        (Box::new(Hardfork::Shanghai), ForkCondition::Timestamp(1699981200)),
        (Box::new(OptimismHardfork::Canyon), ForkCondition::Timestamp(1699981200)),
        (Box::new(Hardfork::Cancun), ForkCondition::Timestamp(1708534800)),
        (Box::new(OptimismHardfork::Ecotone), ForkCondition::Timestamp(1708534800)),
        (Box::new(OptimismHardfork::Fjord), ForkCondition::Timestamp(1716998400)),
    ])
});
