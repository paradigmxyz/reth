...
pub static OP_MAINNET_HARDFORKS: Lazy<BTreeMap<Hardfork, ForkCondition>> = Lazy::new(|| {
    BTreeMap::from([
...
pub static OP_SEPOLIA_HARDFORKS: Lazy<BTreeMap<Hardfork, ForkCondition>> = Lazy::new(|| {
    BTreeMap::from([
        (Hardfork::Frontier, ForkCondition::Block(0)),
        (Hardfork::Homestead, ForkCondition::Block(0)),
        (Hardfork::Tangerine, ForkCondition::Block(0)),
...
pub static BASE_SEPOLIA_HARDFORKS: Lazy<BTreeMap<Hardfork, ForkCondition>> = Lazy::new(|| {
    BTreeMap::from([
        (Hardfork::Frontier, ForkCondition::Block(0)),
        (Hardfork::Homestead, ForkCondition::Block(0)),
        (Hardfork::Tangerine, ForkCondition::Block(0)),
...
pub static BASE_MAINNET_HARDFORKS: Lazy<BTreeMap<Hardfork, ForkCondition>> = Lazy::new(|| {
    BTreeMap::from([
        (Hardfork::Frontier, ForkCondition::Block(0)),
        (Hardfork::Homestead, ForkCondition::Block(0)),
        (Hardfork::Tangerine, ForkCondition::Block(0)),
