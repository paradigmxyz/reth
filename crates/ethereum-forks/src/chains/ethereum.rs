...
pub const MAINNET_HARDFORKS: Lazy<EthereumForks> = Lazy::new(|| {
    EthereumForks(vec![
        ...
        (Hardfork::Homestead.boxed(), ForkCondition::Block(1150000)),
        (Hardfork::Dao.boxed(), ForkCondition::Block(1920000)),
        (Hardfork::Tangerine.boxed(), ForkCondition::Block(2463000)),
        (Hardfork::SpuriousDragon.boxed(), ForkCondition::Block(2675000)),
        (Hardfork::Byzantium.boxed(), ForkCondition::Block(4370000)),
        (Hardfork::Constantinople.boxed(), ForkCondition::Block(7280000)),
        (Hardfork::Petersburg.boxed(), ForkCondition::Block(7280000)),
        (Hardfork::Istanbul.boxed(), ForkCondition::Block(9069000)),
        (Hardfork::MuirGlacier.boxed(), ForkCondition::Block(9200000)),
        (Hardfork::Berlin.boxed(), ForkCondition::Block(12244000)),
        (Hardfork::London.boxed(), ForkCondition::Block(12965000)),
        (Hardfork::ArrowGlacier.boxed(), ForkCondition::Block(13773000)),
        (Hardfork::GrayGlacier.boxed(), ForkCondition::Block(15050000)),
        (
        ...
        (Hardfork::Shanghai.boxed(), ForkCondition::Timestamp(1681338455)),
        (Hardfork::Cancun.boxed(), ForkCondition::Timestamp(1710338135)),
    ])
});
...
pub static SEPOLIA_HARDFORKS: Lazy<EthereumForks> = Lazy::new(|| {
    EthereumForks(vec![
        ...
        (Hardfork::Shanghai.boxed(), ForkCondition::Timestamp(1677557088)),
        (Hardfork::Cancun.boxed(), ForkCondition::Timestamp(1706655072)),
    ])
});
...
pub const HOLESKY_HARDFORKS: Lazy<EthereumForks> = Lazy::new(|| {
    EthereumForks(vec![
        ...
        (Hardfork::Shanghai.boxed(), ForkCondition::Timestamp(1696000704)),
        (Hardfork::Cancun.boxed(), ForkCondition::Timestamp(1707305664)),
    ])
});
