...
pub struct RayonConfig {
    ...
    /// Number of threads for the prewarming pool (parallel transaction prewarming).
    /// If `None`, derived from available parallelism.
    pub prewarm_threads: Option<usize>,
}
...
impl RayonConfig {
    ...
    pub const fn with_prewarm_threads(mut self, prewarm_threads: usize) -> Self {
        self.prewarm_threads = Some(prewarm_threads);
        self
    }
...
struct RuntimeInner {
    ...
    /// Prewarming pool (parallel transaction prewarming).
    #[cfg(feature = "rayon")]
    prewarm_pool: rayon::ThreadPool,
...
impl Runtime {
    ...
    #[cfg(feature = "rayon")]
    pub fn prewarm_pool(&self) -> &rayon::ThreadPool {
        &self.0.prewarm_pool
    }
}
...
impl RuntimeBuilder {
    ...
    pub fn build(self) -> Result<Runtime, RuntimeBuildError> {
        ...
        let (
            ...
            let prewarm_threads = config.rayon.prewarm_threads.unwrap_or(default_threads);
            let prewarm_pool = rayon::ThreadPoolBuilder::new()
