...
//! - Re-uses cursors and allocations across calculations
//! - Supports lazy evaluation of leaf values; useful for parallelizing.
...
pub struct ProofCalculator<TC, HC, VE: ValueEncoder> {
    ...
    hashed_cursor: HC,
    /// Placeholder, there will be more here in upcoming PRs.
