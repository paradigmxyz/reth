...
mod test {
    ...
    const HACK_RECEIPT_ENCODED_BLOCK_1_AND_BLOCK_2: &[u8] = &hex!("");
    ...
    fn decode_hack_receipt() {
        ...
        let decoded =
            HackReceiptContainer::decode(&mut &HACK_RECEIPT_ENCODED_BLOCK_1_AND_BLOCK_2[..])
                .unwrap()
                .0;
    ...
    fn receipts_codec() {
        ...
        // OP mainnet receipt of tx in block 1 and 2
        let first_receipt = receipt_block_1();
        let second_receipt = receipt_block_2();
        ...
        let first_decoded_receipt = codec.decode(encoded).unwrap().unwrap();

        assert_eq!(first_receipt, first_decoded_receipt);

        let second_decoded_receipt = codec.decode(encoded).unwrap().unwrap();

        assert_eq!(second_receipt, second_decoded_receipt);
    }
}
