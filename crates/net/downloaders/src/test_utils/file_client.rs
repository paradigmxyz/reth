...
pub struct FileClient {
    ...
    /// An index of block number to file offset and rlp length.
    block_index: HashMap<BlockNumber, BlockPosition>,
...
/// The position and rlp length of a block in the file.
#[derive(Debug, Clone)]
pub struct BlockPosition {
    /// The offset of the block in the file.
    pub offset: u64,

    /// The rlp length of the block, including the length of the rlp header.
    pub length: u64,
}
