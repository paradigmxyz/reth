...
hash_map_handle_payload_impl!(ValidAnnouncementData,);
...
impl ValidAnnouncementData {
    ...
    /// Returns the version of the message this data was received in, either
    /// [`Eth66`](EthVersion::Eth66) or [`Eth68`](EthVersion::Eth68).
    pub fn msg_version(&self) -> EthVersion {
        self.version
    }
