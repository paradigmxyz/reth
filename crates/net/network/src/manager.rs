        ...
        duration_metered_exec!(
            {
                ...
                // scheduler. This manual yield point should prevent situations where polling appears to be frozen. See also <https://tokio.rs/blog/2020-04-preemption>
                            ...
                            match event {
                                ...
                                SwarmEvent::IncomingTcpConnection { remote_addr, session_id } => {
                                    ...
                                    this.metrics
                                        ...
                                        .set(this.swarm.state().peers().num_inbound_connections()
                                            as f64);
                                }
                                SwarmEvent::OutgoingTcpConnection { remote_addr, peer_id } => {
                                    ...
                                    this.metrics
                                        ...
                                        .set(this.swarm.state().peers().num_outbound_connections()
                                            as f64);
                                }
                                ...
                                SwarmEvent::OutgoingConnectionError {
                                    ...
                                    this.swarm
                                        .state_mut()
                                        .peers_mut()
                                        .on_outgoing_connection_failure(
                                            &remote_addr,
                                            &peer_id,
                                            &error,
                                        );
