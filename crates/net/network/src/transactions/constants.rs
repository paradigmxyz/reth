...
pub(super) const SOFT_LIMIT_COUNT_HASHES_IN_NEW_POOLED_TRANSACTIONS_BROADCAST_MESSAGE: usize = 4096;

/// Default soft limit for the byte size of a [`Transactions`](reth_eth_wire::Transactions)
/// broadcast message. Default is 128 KiB.
pub(super) const DEFAULT_SOFT_LIMIT_BYTE_SIZE_TRANSACTIONS_BROADCAST_MESSAGE: usize = 128 * 1024;
...
pub(super) const DEFAULT_SOFT_LIMIT_BYTE_SIZE_POOLED_TRANSACTIONS_RESPONSE: usize = 128 * 1024;
...
pub(super) const AVERAGE_BYTE_SIZE_TX_ENCODED: usize =
...
pub(super) const MEDIAN_BYTE_SIZE_SMALL_LEGACY_TX_ENCODED: usize = 120;
...
pub(super) const DEFAULT_CAPACITY_CACHE_SEEN_BY_PEER_AND_IN_POOL: usize = 10 * 1024;
...
pub(super) const DEFAULT_CAPACITY_CACHE_SENT_BY_PEER_AND_MAYBE_IN_POOL: usize = 10 * 1024;

/// Default maximum pending pool imports to tolerate.
pub(super) const DEFAULT_MAX_COUNT_PENDING_POOL_IMPORTS: usize =
    SOFT_LIMIT_COUNT_HASHES_GET_POOLED_TRANSACTIONS_REQUEST *
...
/// most [`DEFAULT_MAX_RETRIES`], which defaults to 2 peers, can ever be needed per peer. Default
/// is the sum of [`DEFAULT_MAX_RETRIES`] and [`DEFAULT_MARGINAL_COUNT_FALLBACK_PEERS`], which
/// defaults to 1 peer, so 3 peers.
pub(super) const DEFAULT_MAX_COUNT_FALLBACK_PEERS: u8 =
...
/// requests. Default is the product of [`DEFAULT_MAX_COUNT_CONCURRENT_REQUESTS_PER_PEER`], which
...
pub(super) const DEFAULT_MAX_CAPACITY_CACHE_PENDING_FETCH: usize =
...
/// hashes.
pub(super) const DEFAULT_MAX_COUNT_PENDING_FETCH: usize =
...
/// is budget constrained. Default is a sixth of [`DEFAULT_MAX_COUNT_PENDING_FETCH`], which
/// defaults to 12 800 hashes (the breadth of the search), divided by
/// [`DEFAULT_MAX_COUNT_FALLBACK_PEERS`], which defaults to 3 peers (the depth of the search), so
/// the 711 lru hashes in the pending hashes cache.
pub(super) const DEFAULT_BUDGET_FIND_IDLE_FALLBACK_PEER: usize =
...
pub(super) const DEFAULT_BUDGET_FIND_INTERSECTION_ANNOUNCED_BY_PEER_AND_PENDING_FETCH: usize =
...
pub(super) const DEFAULT_MAX_INFLIGHT_REQUESTS_ON_FETCH_PENDING_HASHES: usize =
    DEFAULT_MAX_COUNT_CONCURRENT_REQUESTS as usize / 2;

/// Default soft limit for the number of hashes in a
/// [`GetPooledTransactions`](reth_eth_wire::GetPooledTransactions) request, when it is filled from
/// hashes pending fetch. Default is half of the
/// [`SOFT_LIMIT_COUNT_HASHES_GET_POOLED_TRANSACTIONS_REQUEST`] which by spec is 256 hashes, so
/// 128 hashes.
pub(super) const DEFAULT_SOFT_LIMIT_COUNT_HASHES_IN_GET_POOLED_TRANSACTIONS_REQUEST_ON_FETCH_PENDING_HASHES:
...
/// 128 KiB.
pub(super) const DEFAULT_SOFT_LIMIT_BYTE_SIZE_POOLED_TRANSACTIONS_RESPONSE_ON_FETCH_PENDING_HASHES: usize =
