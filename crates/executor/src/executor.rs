...
pub struct AccountChangeSet {
    /// Old and New account.
    /// If account is deleted (selfdestructed) or if we have touched empty account we would have
    /// (Some,None). (Look at state clear EIP https://eips.ethereum.org/EIPS/eip-161)
