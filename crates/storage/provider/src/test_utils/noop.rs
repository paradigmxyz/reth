...
impl BlockReader for NoopProvider {
    ...
    fn block_body_indices_with_db_info(
        ...
        Ok((self.block_body_indices(num)?, 0, 0))
    }
    ...
    fn block_with_senders_with_db_info(
        &self,
        number: BlockNumber,
    ) -> Result<(Option<reth_primitives::BlockWithSenders>, u64, u128)> {
        Ok((self.block_with_senders(number)?, 0, 0))
    }
...
impl TransactionsProvider for NoopProvider {
    ...
    fn senders_by_tx_range_with_db_info(
        ...
        Ok((self.senders_by_tx_range(range)?, 0, 0))
    }
    ...
    fn transactions_by_tx_range_with_db_info(
        ...
        Ok((self.transactions_by_tx_range(range)?, 0, 0))
    }
...
impl HeaderProvider for NoopProvider {
    ...
    fn header_by_number_with_db_info(
        ...
        Ok((self.header_by_number(num)?, 0, 0))
    }
    ...
    fn header_td_by_number_with_db_info(
        ...
        Ok((self.header_td_by_number(number)?, 0, 0))
    }
...
impl WithdrawalsProvider for NoopProvider {
    ...
    fn withdrawals_by_block_with_db_info(
        ...
        id: BlockHashOrNumber,
        timestamp: u64,
    ) -> Result<(Option<Vec<reth_primitives::Withdrawal>>, u64, u128)> {
        Ok((self.withdrawals_by_block(id, timestamp)?, 0, 0))
    }
}
