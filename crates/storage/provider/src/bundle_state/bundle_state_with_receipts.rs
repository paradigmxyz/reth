...
mod tests {
    ...
    fn write_to_db_storage() {
        ...
        BlockExecutionOutcome::new(state.take_bundle(), Receipts::default(), 1, Vec::new())
        ...
        state.merge_transitions(BundleRetention::Reverts);
        BlockExecutionOutcome::new(state.take_bundle(), Receipts::default(), 2, Vec::new())
            .write_to_storage(provider.tx_ref(), None, OriginalValuesKnown::Yes)
            .expect("Could not write bundle state to DB");
    ...
    fn write_to_db_multiple_selfdestructs() {
        ...
        BlockExecutionOutcome::new(init_state.take_bundle(), Receipts::default(), 0, Vec::new())
            .write_to_storage(provider.tx_ref(), None, OriginalValuesKnown::Yes)
        ...
        BlockExecutionOutcome::new(bundle, Receipts::default(), 1, Vec::new())
            .write_to_storage(provider.tx_ref(), None, OriginalValuesKnown::Yes)
            .expect("Could not write bundle state to DB");
    ...
    fn revert_to_indices() {
        let base = BlockExecutionOutcome {
    ...
    fn prepend_state() {
        ...
        let mut test = BlockExecutionOutcome {
