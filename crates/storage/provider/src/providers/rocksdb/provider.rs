...
impl RocksDBBuilder {
    ...
    fn default_options(
        ...
        // Speed up WAL cleanup - delete obsolete files immediately after flush
        // This ensures WAL files are removed as soon as all column families have flushed
        options.set_delete_obsolete_files_period_micros(0);
