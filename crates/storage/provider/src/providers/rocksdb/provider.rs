...
/// Default write buffer size for `RocksDB` memtables (256 MB).
///
/// Larger memtables reduce flush frequency during burst writes, providing more consistent tail
/// latency for large history batches.
const DEFAULT_WRITE_BUFFER_SIZE: usize = 256 << 20;
