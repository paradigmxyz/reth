    ...
    ($target:ty $(where [$($generics:tt)*])?) => {
        $crate::providers::state::macros::delegate_impls_to_as_ref!(
            ...
            StateRootProvider $(where [$($generics)*])? {
                ...
                fn state_root_from_nodes(&self, input: reth_trie::TrieInputSorted) -> reth_storage_errors::provider::ProviderResult<alloy_primitives::B256>;
                ...
                fn state_root_from_nodes_with_updates(&self, input: reth_trie::TrieInputSorted) -> reth_storage_errors::provider::ProviderResult<(alloy_primitives::B256, reth_trie::updates::TrieUpdates)>;
            }
