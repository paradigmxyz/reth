...
impl<'b, TX: DbTx, SC> HistoricalStateProviderRef<'b, TX, SC> {
...
impl<TX: DbTx, SC: Send + Sync> AccountReader for HistoricalStateProviderRef<'_, TX, SC> {
...
impl<TX: DbTx, SC: Send + Sync> StateRootProvider for HistoricalStateProviderRef<'_, TX, SC> {
...
impl<TX: DbTx, SC: Send + Sync> StorageRootProvider for HistoricalStateProviderRef<'_, TX, SC> {
    fn storage_root(
        &self,
        address: Address,
...
impl<TX: DbTx, SC: Send + Sync> StateProofProvider for HistoricalStateProviderRef<'_, TX, SC> {
...
impl<TX: DbTx, SC: Send + Sync> StateProvider for HistoricalStateProviderRef<'_, TX, SC> {
    /// Get storage.
    fn storage(
        &self,
        address: Address,
...
impl<TX: DbTx, SC> HistoricalStateProvider<TX, SC> {
    /// Create new `StateProvider` for historical block number
    pub fn new(
        tx: TX,
        block_number: BlockNumber,
...
delegate_provider_impls!(HistoricalStateProvider<TX, SC> where [TX: DbTx, SC: Send + Sync]);
