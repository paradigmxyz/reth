...
mod tests {
    ...
    fn test_methods_by_tx_range() -> eyre::Result<()> {
        test_by_tx_range!([
            (
                senders_by_tx_range,
                |block: &SealedBlock, _: &Vec<Vec<Receipt>>| block.senders().unwrap()
            ),
            (
                transactions_by_tx_range,
                |block: &SealedBlock, _: &Vec<Vec<Receipt>>| block.body().transactions.clone()
            ),
            (
                receipts_by_tx_range,
                |block: &SealedBlock, receipts: &Vec<Vec<Receipt>>| receipts[block.number as usize]
                    .clone()
            )
        ]);
    ...
    fn test_methods_by_block_range() -> eyre::Result<()> {
        ...
        test_by_block_range!([
            ...
            (sealed_headers_range, |block: &SealedBlock| block
                .clone_sealed_header()),
            (block_range, |block: &SealedBlock| block
                .clone()
                .into_block()),
            (block_with_senders_range, |block: &SealedBlock| block
                ...
                .try_recover()
                .unwrap()),
            (recovered_block_range, |block: &SealedBlock| block
                .clone()
                .try_recover()
                .unwrap()),
