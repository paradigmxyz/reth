use crate::{
    ...
    traits::{
        AccountChangeReader, AccountExtReader, BlockSource, ReceiptProvider, StageCheckpointWriter,
    },
...
impl<'this, TX: DbTx<'this>> AccountChangeReader for DatabaseProvider<'this, TX> {
