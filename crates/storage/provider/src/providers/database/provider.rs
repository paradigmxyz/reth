...
impl<'this, TX: DbTxMut<'this> + DbTx<'this>> DatabaseProvider<'this, TX> {
    ...
    ///
    /// Returns number of total unique keys and total rows pruned. For dupsort tables, these numbers
    /// will be different as one key can correspond to multiple rows.
