...
/// Keep large writemap transactions below MDBX's dirty-page spill threshold.
const LARGE_WRITE_TXN_DIRTY_PAGE_LIMIT: u64 = 4 * 1024 * 1024;
...
impl DatabaseEnv {
    ...
    pub fn open(
        ...
        if kind.is_rw() {
            inner_env.set_txn_dp_limit(LARGE_WRITE_TXN_DIRTY_PAGE_LIMIT);
        }
