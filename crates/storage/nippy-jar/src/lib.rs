...
impl<H: NippyJarHeader> NippyJar<H> {
    ...
    pub fn freeze(
        ...
        let mut writer = NippyJarWriter::new(self, false)?;
...
mod tests {
    ...
    fn test_append_consistency_partial_commit(
        ...
        // Appends a third row
        let mut writer = NippyJarWriter::new(nippy, false).unwrap();
        ...
        // accordingly as well.
        let writer = NippyJarWriter::new(nippy, false).unwrap();
    ...
    fn simulate_interrupted_prune(
        ...
        let _ = NippyJarWriter::new(nippy, false).unwrap();
    }
}
