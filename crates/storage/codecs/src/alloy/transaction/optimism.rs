...
use crate::{
    alloy::transaction::envelope::impl_compact_tx_envelope,
    generate_tests,
    txtype::{
...
impl crate::alloy::transaction::envelope::ToTxCompact for OpTxEnvelope {
...
impl crate::alloy::transaction::envelope::FromTxCompact for OpTxEnvelope {
...
lazy_static! {
    static ref DEPOSIT_SIGNATURE: PrimitiveSignature =
...
impl_compact_tx_envelope!(OpTxEnvelope);
