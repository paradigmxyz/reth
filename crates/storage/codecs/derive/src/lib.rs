...
/// The amount of bits used to store a field is determined by the field's type. For specific types,
/// a minimal number of bits is allocated (from `fn get_bit_size`):
