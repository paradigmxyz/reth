    ...
    ($target:ty $(where [$($generics:tt)*])?) => {
        $crate::macros::delegate_impls_to_as_ref!(
            ...
            AccountReader $(where [$($generics)*])? {
                ...
                fn basic_account_by_hashed(&self, address: &alloy_primitives::Address, hashed_address: alloy_primitives::B256) -> reth_storage_api::errors::provider::ProviderResult<Option<reth_primitives_traits::Account>>;
            }
