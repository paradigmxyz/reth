    ...
    ($target:ty $(where [$($generics:tt)*])?) => {
        $crate::macros::delegate_impls_to_as_ref!(
            ...
            StorageRootProvider $(where [$($generics)*])? {
                ...
                fn storage_root_from_nodes(&self, address: alloy_primitives::Address, storage: reth_trie::HashedStorage, nodes: &reth_trie::updates::StorageTrieUpdatesSorted) -> reth_storage_api::errors::provider::ProviderResult<alloy_primitives::B256>;
                ...
                fn storage_proof_from_nodes(&self, address: alloy_primitives::Address, slot: alloy_primitives::B256, storage: reth_trie::HashedStorage, nodes: &reth_trie::updates::StorageTrieUpdatesSorted) -> reth_storage_api::errors::provider::ProviderResult<reth_trie::StorageProof>;
                ...
                fn storage_multiproof_from_nodes(&self, address: alloy_primitives::Address, slots: &[alloy_primitives::B256], storage: reth_trie::HashedStorage, nodes: &reth_trie::updates::StorageTrieUpdatesSorted) -> reth_storage_api::errors::provider::ProviderResult<reth_trie::StorageMultiProof>;
            }
