...
/// Uses 2x available parallelism to maximize I/O-bound throughput, clamped between 2 and 64.
/// Storage workers perform blocking MDBX reads which benefit from high concurrency.
