...
pub struct TreeConfig {
    ...
    ///
    /// This trusts the block header's state root and keeps prewarming/Lthash work active. It is
    /// intended for experiments that measure execution without MPT state-root work.
