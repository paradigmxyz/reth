...
pub struct TreeConfig {
    ...
    /// Whether to disable the new state root task calculation method instead of parallel
    /// calculation
    disable_state_root_task: bool,
...
impl TreeConfig {
    ...
    /// Returns whether to disable the state root task calculation method.
    pub const fn disable_state_root_task(&self) -> bool {
        self.disable_state_root_task
    }
    ...
    pub const fn with_disable_state_root_task(mut self, disable_state_root_task: bool) -> Self {
        self.disable_state_root_task = disable_state_root_task;
        self
    }
