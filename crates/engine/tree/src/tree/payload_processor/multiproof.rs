...
impl MultiProofTask {
    ...
    #[instrument(target = "engine::tree::payload_processor::multiproof", skip_all, fields(accounts = targets.len()))]
    ...
    ///
    /// Returns a number of proofs that were spawned.
    #[instrument(target = "engine::tree::payload_processor::multiproof", skip(update), fields(accounts = update.len()))]
    ...
    #[instrument(target = "engine::tree::payload_processor::multiproof", skip_all)]
