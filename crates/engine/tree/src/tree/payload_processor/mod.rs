...
mod tests {
    use crate::tree::{
        payload_processor::{
            process_and_convert_evm_state, executor::WorkloadExecutor, PayloadProcessor,
        },
    ...
    use reth_trie::{added_removed_keys::MultiAddedRemovedKeys, test_utils::state_root, HashedPostState, TrieInput};
    ...
    fn test_state_root() {
        ...
        for update in &state_updates {
            hashed_state.extend(process_and_convert_evm_state(update.clone(), &mut added_removed_keys));
