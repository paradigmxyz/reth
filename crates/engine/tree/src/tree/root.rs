        ...
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let prefix_sets_storages = self
                    ...
                    .map(|set| set.len())
                    .sum::<usize>();
                let prefix_sets_destroyed_accounts =
                    self.config.prefix_sets.destroyed_accounts.len();
                ...
                debug!(
                    ...
                    "State root task starting"
                );

                self.metrics
                    .nodes_sorted_account_nodes_histogram
                    .record(nodes_sorted_account_nodes as f64);
                self.metrics
                    .nodes_sorted_removed_nodes_histogram
                    .record(nodes_sorted_removed_nodes as f64);
                self.metrics
                    .nodes_sorted_storage_tries_histogram
                    .record(nodes_sorted_storage_tries as f64);
