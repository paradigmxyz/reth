    ...
    Evm: ConfigureEvm<Primitives = N> + 'static,
{
        ...
        Evm: ConfigureEngineEvm<T::ExecutionData, Primitives = N>,
    {
        ...
        match strategy {
            StateRootStrategy::StateRootTask => {
                trace!(target: "engine::tree::payload_validator", "Using sparse trie state root algorithm");
        ...
        trace!(target: "engine::tree::payload_validator", ?root_elapsed, "Calculated state root");
    ...
    where
        ...
        Evm: ConfigureEngineEvm<T::ExecutionData, Primitives = N>,
    {
        trace!(target: "engine::tree::payload_validator", "Executing block");
        ...
        trace!(target: "engine::tree::payload_validator", elapsed = ?execution_duration, "Executed block");
    ...
    where
        ...
        V: PayloadValidator<T, Block = N::Block>,
    {
        trace!(target: "engine::tree::payload_validator", "Executing block via BAL path");
