...
/// new canonical chain. The unwind therefore has to find the chain of the persisted tip among the
/// pending blocks the reorg moved off the canonical chain: completing the trie at Finish from the
/// canonical head instead fails, which takes the persistence service down with it.
///
