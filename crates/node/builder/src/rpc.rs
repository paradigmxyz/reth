...
impl<Node: FullNodeComponents> RpcHooks<Node, EthApi> {
...
impl<Node: FullNodeComponents> fmt::Debug for RpcHooks<Node, EthApi> {
...
impl<Node: FullNodeComponents, EthApi> ExtendRpcModules<Node> for () {
