...
use reth_node_api::{
    BlockTy, BuiltPayload, EngineValidator, FullNodeTypes, NodePrimitives, NodeTypesWithEngine,
...
where
    Types: ProviderNodeTypes<Primitives: NodePrimitives<BlockHeader = alloy_consensus::Header>>
        + EngineNodeTypes,
