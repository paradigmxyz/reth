...
use reth_provider::{
    ...
    BlockExecutionOutcome, HeaderSyncMode,
};
...
enum TestExecutorConfig {
    ...
    Test(Vec<BlockExecutionOutcome>),
...
impl TestConsensusEngineBuilder {
    ...
    pub fn with_executor_results(mut self, executor_results: Vec<BlockExecutionOutcome>) -> Self {
