...
impl From<reth_net_p2p::db::DatabaseError> for BeaconConsensusEngineError {
    fn from(e: reth_net_p2p::db::DatabaseError) -> Self {
        Self::Common(e.into())
    }
}
...
impl From<reth_net_p2p::db::DatabaseError> for BeaconForkChoiceUpdateError {
    fn from(e: reth_net_p2p::db::DatabaseError) -> Self {
