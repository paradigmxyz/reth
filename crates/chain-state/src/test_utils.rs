...
/// their execution.
#[derive(Debug)]
pub struct TestBlockBuilder<P: NodePrimitives = reth_primitives::EthPrimitives> {
    ...
    _prims: PhantomData<P>,
}

impl<P: NodePrimitives> Default for TestBlockBuilder<P> {
    fn default() -> Self {
...
pub struct TestCanonStateSubscriptions<P: NodePrimitives = reth_primitives::EthPrimitives> {
    canon_notif_tx: Arc<Mutex<Vec<Sender<CanonStateNotification<P>>>>>,
}
