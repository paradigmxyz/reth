...
///
/// Raised from the Ethereum-standard 32 bytes to 3309 bytes to accommodate
/// ML-DSA-65 post-quantum signatures used as PoA seals in extra_data.
pub const MAXIMUM_EXTRA_DATA_SIZE: usize = 3309;
