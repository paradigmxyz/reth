use reth_primitives::{
     Block as PrimitiveBlock,
     H256, U256, Header as PrimitiveHeader
};
use reth_rpc_types::{Header,Block,BlockTransactionsKind,BlockError,BlockTransactions};
    ...
    pub fn from_block(
        ...
        match kind {
            ...
            BlockTransactionsKind::Full => {
                from_block_full(block, total_difficulty, block_hash)
            }
        }
    }
