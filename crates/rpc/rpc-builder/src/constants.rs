...
/// The secondary port for the http server
pub const SECONDARY_HTTP_RPC_PORT: u16 = 8544;

/// The default port for the ws server
pub const DEFAULT_WS_RPC_PORT: u16 = 8546;

/// The secondary port for the ws server
pub const SECONDARY_WS_RPC_PORT: u16 = 8547;

/// The default port for the auth server.
pub const DEFAULT_AUTH_PORT: u16 = 8551;

/// The secondary port for the auth server.
pub const SECONDARY_AUTH_PORT: u16 = 8552;
