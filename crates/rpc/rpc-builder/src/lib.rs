    ...
    EthApi: Clone,
{
    ...
    where
        EthApi: EthApiServer<reth_rpc_types::Transaction, reth_rpc_types::RichBlock>,
    {
    ...
    where
        EthApi: EthApiServer<reth_rpc_types::Transaction, reth_rpc_types::RichBlock> + TraceExt,
    {
