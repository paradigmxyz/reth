...
pub type EthRpcConverter<ChainSpec> =
    RpcConverter<Ethereum, EthEvm2Config, EthReceiptConverter<ChainSpec>>;
...
mod tests {
    ...
    use reth_evm::database::{CacheDB, EmptyDBTyped};
    ...
    fn test_resolve_transaction_empty_request() {
        ...
        let mut db = CacheDB::<EmptyDBTyped<reth_errors::ProviderError>>::default();
