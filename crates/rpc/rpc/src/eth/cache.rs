...
pub const DEFAULT_BLOCK_CACHE_SIZE_BYTES: usize = 500 * 1024 * 1024;

/// Default cache size for the receipts cache: 500MB
pub const DEFAULT_RECEIPT_CACHE_SIZE_BYTES: usize = 500 * 1024 * 1024;

/// Default cache size for the env cache: 1MB
pub const DEFAULT_ENV_CACHE_SIZE_BYTES: usize = 1024 * 1024;
...
impl Default for EthStateCacheConfig {
    fn default() -> Self {
        Self {
            ...
            max_env_bytes: DEFAULT_ENV_CACHE_SIZE_BYTES,
        }
    }
}
