...
use reth_primitives::{
    ...
    IntoRecoveredTransaction, SealedBlock, SealedBlockWithSenders, TransactionSigned,
...
use reth_rpc_types::{
    ...
    AnyTransactionReceipt, Index, Transaction, TransactionInfo, TransactionRequest,
