...
use reth_rpc_types::{AnyReceiptEnvelope, Header, Index, RichBlock, TransactionReceipt, WithOtherFields};
    ...
    EvmConfig: ConfigureEvmEnv + 'static,
{
    ...
    pub(crate) async fn block_receipts(
        &self,
        block_id: BlockId,
    ) -> EthResult<Option<Vec<WithOtherFields<TransactionReceipt<AnyReceiptEnvelope>>>>> {
