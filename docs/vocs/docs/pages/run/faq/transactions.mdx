...
[EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) transactions (type `0x4`) were introducedin Ethereum's Pectra fork. This provides the ability for a wallet to delegate its execution to an authorized smart contract. Alongside the fields present from previous transaction types, EIP-7702 transactions include:
- `authorization_list`
- `signature_y_parity`
- `signature_r`
- `signature_s`

where `authorization_list` is a list of tuples
- `chain_id`
- `address`
- `nonce`
- `y_parity`
