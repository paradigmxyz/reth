...
comprising the following key changes:
...
Next, you'll need to install a [Rollup Node][rollup-node-spec], which is the equivalent of the Consensus Client on the OP Stack. Available options include:
