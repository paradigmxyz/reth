...
We also use our Ethereum libraries, including [Alloy](https://github.com/alloy-rs/alloy/), which we've battle-tested and optimized via [Foundry](https://github.com/foundry-rs/foundry/).
...
1. EVM state tests are run as part of CI.
...
| OP       | 10       | Full    | [View](https://reth.ithaca.xyz/public-dashboards/aa32f6c39a664f9aa371399b59622527) |
