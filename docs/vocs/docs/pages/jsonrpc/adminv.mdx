...
```js
// > {"jsonrpc":"2.0","id":1,"method":"adminv_addTrustedPeer","params":["enode://a979fb575495b8d6db44f750317d0f4622bf4c2aa3365d6af7c284339968eef29b69ad0dce72a4d8db5ebb4968de0e3bec910127f134779fbcb0cb6d3331163c@52.16.188.185:30303"]}
{"jsonrpc":"2.0","id":1,"result":true}
```
...
```js
// > {"jsonrpc":"2.0","id":1,"method":"adminv_removeTrustedPeer","params":["enode://a979fb575495b8d6db44f750317d0f4622bf4c2aa3365d6af7c284339968eef29b69ad0dce72a4d8db5ebb4968de0e3bec910127f134779fbcb0cb6d3331163c@52.16.188.185:30303"]}
{"jsonrpc":"2.0","id":1,"result":true}
```
...
| Client | Method invocation              |
| ------ | ------------------------------ |
| RPC    | `{"method": "adminv_nodeInfo"}` |

### Example

```js
// > {"jsonrpc":"2.0","id":1,"method":"adminv_nodeInfo","params":[]}
{
    "jsonrpc": "2.0",
    "id": 1,
    "result": {
...
| Client | Method invocation              |
| ------ | ------------------------------ |
| RPC    | `{"method": "adminv_peers", "params": []}` |

### Example

```js
// > {"jsonrpc":"2.0","id":1,"method":"adminv_peers","params":[]}
...
| Client | Method invocation                         |
| ------ | ----------------------------------------- |
| RPC    | `{"method": "adminv_clearTxpool", "params": []}` |
...
## `admin_peerEvents`, `adminv_peerEvents_unsubscribe`
...
| Client | Method invocation                                            |
| ------ | ------------------------------------------------------------ |
| RPC    | `{"method": "adminv_peerEvents", "params": []}`               |
| RPC    | `{"method": "adminv_peerEvents_unsubscribe", "params": [id]}` |
...
```js
// > {"jsonrpc":"2.0","id":1,"method":"adminv_peerEvents","params":[]}
...
// Unsubscribe
// > {"jsonrpc":"2.0","id":2,"method":"adminv_peerEvents_unsubscribe","params":["0xcd0c3e8af590364c09d0fa6a1210faf5"]}
