...
# reth
reth-codecs = "1.6.0"
reth-ethereum = { version = "1.6.0", features = ["node-api", "network", "evm", "pool", "trie", "storage-api", "provider"] }
reth-op = { version = "1.6.0", features = ["node", "pool", "rpc"] }
...
There may be occasionally additional dependencies needed. Refer to the custom node example for a complete list: https://github.com/paradigmxyz/reth/blob/main/examples/custom-node/Cargo.toml
