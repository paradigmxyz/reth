# op-reth db settings set storages_history_rocksdb

Store storages history in RocksDB instead of the database

```bash
$ op-reth db settings set storages_history_rocksdb --help
```
```txt
Usage: op-reth db settings set storages_history_rocksdb [OPTIONS] <VALUE>
