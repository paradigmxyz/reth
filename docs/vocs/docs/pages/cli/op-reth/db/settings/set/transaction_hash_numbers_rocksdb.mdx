# op-reth db settings set transaction_hash_numbers_rocksdb

Store transaction hash numbers in RocksDB instead of the database

```bash
$ op-reth db settings set transaction_hash_numbers_rocksdb --help
```
```txt
Usage: op-reth db settings set transaction_hash_numbers_rocksdb [OPTIONS] <VALUE>
