# op-reth db settings set account_changesets_rocksdb

Store account changesets in rocksdb instead of MDBX

```bash
$ op-reth db settings set account_changesets_rocksdb --help
```
```txt
Usage: op-reth db settings set account_changesets_rocksdb [OPTIONS] <VALUE>
