# op-reth db settings set storage_changesets_rocksdb

Store storage changesets in rocksdb instead of MDBX

```bash
$ op-reth db settings set storage_changesets_rocksdb --help
```
```txt
Usage: op-reth db settings set storage_changesets_rocksdb [OPTIONS] <VALUE>
