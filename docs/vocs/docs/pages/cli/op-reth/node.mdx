...
Pruning:
      ...
      --minimal
          ...
          This mode configures the node to use minimal disk space by: - Fully pruning sender recovery, transaction lookup, receipts, and block bodies - Leaving 10,064 blocks for account and storage history - Using 10,000 blocks per static file segment
