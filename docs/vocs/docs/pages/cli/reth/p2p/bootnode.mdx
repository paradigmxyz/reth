...
Tracing:
      --tracing-otlp [<URL>]
          ...
          If no value provided, traces are printed to stdout. If a URL is provided, traces are exported to that OTLP endpoint. Example: --tracing-otlp=http://localhost:4318/v1/traces
```