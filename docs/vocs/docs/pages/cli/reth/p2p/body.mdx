...
Networking:
  -d, --disable-discovery
      ...
      --netrestrict <NETRESTRICT>
          ...
          Comma separated list of CIDR network specifications. Only peers with IP addresses within these ranges will be allowed to connect. Similar to geth's --netrestrict flag.
