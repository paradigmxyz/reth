...
TxPool:
      ...
      --txpool.minimal-priority-fee <MINIMAL_PRIORITY_FEE>
          Minimum priority fee required for transaction acceptance into the pool. Transactions with priority fee below this value will be rejected. Set to 0 to disable
