...
Engine:
      ...
      --engine.disable-bal-parallel-execution
          Disable BAL (Block Access List, EIP-7928) based parallel execution. Defaults to disabled, using today's sequential execution path even when a BAL is available
