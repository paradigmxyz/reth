...
Storage:
  ...
  -u, --url <URL>
      ...
      --repair-history
          ...
          Missing transactions, receipts, account changesets, and storage changesets are downloaded without changing the existing configuration or database checkpoints.
