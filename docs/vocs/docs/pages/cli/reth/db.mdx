...
Commands:
  ...
  debug-report        Generates a debug report for state root validation errors. Use this when encountering invalid state root errors to collect all necessary information for bug reports
