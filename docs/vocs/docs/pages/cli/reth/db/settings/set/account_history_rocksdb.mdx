# reth db settings set account_history_rocksdb

Store account history in RocksDB instead of the database

```bash
$ reth db settings set account_history_rocksdb --help
```
```txt
Usage: reth db settings set account_history_rocksdb [OPTIONS] <VALUE>
