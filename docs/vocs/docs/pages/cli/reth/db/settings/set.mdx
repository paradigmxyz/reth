...
Commands:
  ...
  storages_history_rocksdb          Store storages history in RocksDB instead of the database
  transaction_hash_numbers_rocksdb  Store transaction hash numbers in RocksDB instead of the database
  account_history_rocksdb           Store account history in RocksDB instead of the database
