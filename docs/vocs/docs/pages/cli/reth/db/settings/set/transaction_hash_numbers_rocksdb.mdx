# reth db settings set transaction_hash_numbers_rocksdb

Store transaction hash numbers in RocksDB instead of the database

```bash
$ reth db settings set transaction_hash_numbers_rocksdb --help
```
```txt
Usage: reth db settings set transaction_hash_numbers_rocksdb [OPTIONS] <VALUE>
