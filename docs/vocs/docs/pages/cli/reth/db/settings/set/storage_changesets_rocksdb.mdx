# reth db settings set storage_changesets_rocksdb

Store storage changesets in rocksdb instead of MDBX

```bash
$ reth db settings set storage_changesets_rocksdb --help
```
```txt
Usage: reth db settings set storage_changesets_rocksdb [OPTIONS] <VALUE>
