# reth db settings set storages_history_rocksdb

Store storages history in RocksDB instead of the database

```bash
$ reth db settings set storages_history_rocksdb --help
```
```txt
Usage: reth db settings set storages_history_rocksdb [OPTIONS] <VALUE>
