...
#### Network
- `network.connected_peers`: Number of peers currently connected to
...
- `network.incoming_connections`: Total number of incoming connections handled
- `network.outgoing_connections`: Total number of outgoing connections established
