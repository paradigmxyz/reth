...
export declare class EvmModule {
    ...
    private readonly _allowBlocksWithSameTimestamp;
    private readonly _experimentalHardhatNetworkMessageTraceHooks;
    constructor(_node: HardhatNode, _miningTimer: MiningTimer, _logger: ModulesLogger, _allowBlocksWithSameTimestamp: boolean, _experimentalHardhatNetworkMessageTraceHooks?: BoundExperimentalHardhatNetworkMessageTraceHook[]);
