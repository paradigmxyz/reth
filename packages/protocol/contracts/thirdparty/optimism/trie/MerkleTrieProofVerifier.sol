...
/// @title MerkleTrieProofVerifier
/// @notice MerkleTrieProofVerifier is a thin wrapper around the MerkleTrie library that hashes the
/// input
///         keys. Ethereum's state trie hashes input keys before storing them.
contract MerkleTrieProofVerifier {
