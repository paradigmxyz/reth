...
The most important requirement is by far the disk, whereas CPU and RAM requirements are relatively flexible. Below are the requirements for Ethereum Mainnet.
...
Running reth on OP-Stack chains like Base require higher hardware requirements:

{/* TODO: Base Hardware Requirements */}
