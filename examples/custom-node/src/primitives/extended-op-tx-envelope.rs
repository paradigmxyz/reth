...
impl Transaction for extended_op_tx_envelope {
...
impl Typed2718 for extended_op_tx_envelope {
    fn ty(&self) -> u8 {
        match self {
...
impl Decodable2718 for extended_op_tx_envelope {
...
impl Encodable2718 for extended_op_tx_envelope {
...
impl Decodable for extended_op_tx_envelope {
...
impl Encodable for extended_op_tx_envelope {
...
impl InMemorySize for extended_op_tx_envelope {
    fn size(&self) -> usize {
        match self {
...
impl SerdeBincodeCompat for extended_op_tx_envelope {
...
impl Compact for extended_op_tx_envelope {
