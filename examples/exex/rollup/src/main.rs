...
mod tests {
    ...
    use reth_primitives::{
        ...
        BlockNumber, Receipt, SealedBlockWithSenders, Transaction, TransactionKind, TxEip2930,
        U256,
    };
    use rusqlite::Connection;
...
[
   {
    ...
    fn test_execute_block() -> eyre::Result<()> {
        ...
        database.upsert_account(sender_address, |_| Ok(sender.clone()))?;
        ...
        execute_transaction(
            ...
            Transaction::Eip2930(TxEip2930 {
                ...
                gas_limit: 50000,
                gas_price: 1_500_000_000,
                to: TransactionKind::Call(weth_address),
